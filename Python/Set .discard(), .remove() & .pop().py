...
# All of the elements are non-negative integers, 
...
# Explanation
# After completing these 10 operations on the set, 
# we get set([4]). 
# Hence, 
# the sum is 4.
...
# To ensure the proper input of the set, 
