...
# Note that K is indexed from 0 to M-1,
# where M is the number of attributes.

# Note: 
# If two attributes are the same for different rows, 
# for example, 
# if two atheletes are of the same age, 
