...
# b occurs 3 times. 
# It is printed first.
# Both a and c occur 2 times.
# So, 
# a is printed in the second line and c in the third line because a comes before c in the alphabet.

# Note: 
# The string  has at least  distinct characters.
