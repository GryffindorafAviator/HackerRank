...
# For the first word in group B, 
# 'a', 
# it appears at positions 1 and 3 in group A. 
# The second word, 
# 'c', 
# does not appear in group A, 
# so print -1.
...
# if 'c' also appeared in word group B, 
# you would print -1.
