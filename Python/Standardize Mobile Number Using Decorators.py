...
# The given mobile numbers may have +91,
# 91 or 0 written before the actual 10 digit number. 
# Alternatively, 
...
# Python has the concept of closures. 
# Extending these closures gives us decorators, 
# which are an invaluable asset. 
# You can learn about decorators in 12 easy steps here.
# To solve the above question, 
# make a list of the mobile numbers and pass it to a function that sorts the array in ascending order. 
