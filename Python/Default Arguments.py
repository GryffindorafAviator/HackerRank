...
# we can assign a default value which is going to be used as the value of said argument if the function is called without it. 
# For example, 
...
# In the first line, 
# there is a single integer q denoting the number of queries. 
...
# In the first query, 
# the function print_from_stream(2, OddStream()) is exectuted, 
# which leads to printing values 1 and 3 in separated lines as the first two non-negative odd numbers.
# In the second query, 
# the function print_from_stream(3) is exectuted, 
# which leads to printing values 2, 4 and 6 in separated lines as the first three non-negative even numbers.
# In the third query, 
# the function print_from_stream(5, OddStream()) is exectuted, 
# which leads to printing values 1, 3, 5, 7 and 9 in separated lines as the first five non-negative odd numbers.
