...
# In the first line, 
# there is a single integer n denoting the number of words. 
# In the second line, 
# there are n space-separated lowercase words.
...
# Explanation 0
# There are two words in the input: 
# hacker and book. 
# The score of the word hacker is 2 because it contains an even number of vowels, 
# i.e. 2 vowels, 
# and the score of book is 2 for the same reason. 
...
# Explanation 1
# There are 3 words in the input: 
# programming, 
# is and awesome. 
# The score of programming is 1 since it contains 3 vowels, 
# an odd number of vowels. 
# The score of is is also 1 because it has an odd number of vowels. 
# The score of awesome is 2 since it contains 4 vowels, 
