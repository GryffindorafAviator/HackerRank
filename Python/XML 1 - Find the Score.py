...
# and you have to print its score. 
...
# the integer score of the given XML document.
...
# The link tag has three attributes - rel, 
# type and href.

# So, 
# the total score is 1 + 1 + 3 = 5.

# There may be any level of nesting in the XML document. 

# NOTE: 
# In order to parse and generate an XML element tree, 
# use the following code:
# >> import xml.etree.ElementTree as etree
# >> tree = etree.ElementTree(etree.fromstring(xml))

# Here, 
# XML is the variable containing the string.
# Also, 
# to find the number of keys in a dictionary, 
...
def get_attr_number(node):
    # return sum([len(elem.items()) for elem in tree.iter()]) # also works
