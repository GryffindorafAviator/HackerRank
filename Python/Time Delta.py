# When users post an update on social media,
# such as a URL, 
# image, 
# status update etc., 
...
# representing time t1 and time t2.
...
# Explanation 0
# In the first query, 
# when we compare the time in UTC for both the time stamps, 
# we see a difference of 7 hours. 
# Which is 7 * 3600 seconds or 25200 seconds.

# Similarly, 
# in the second query, 
# time difference is 5 hours and 30 minutes for time zone adjusting for that we have a difference of 1 day and 30 minutes. 
# Or 
# 24 * 3600 + 30 * 60 = 88200
...
def time_delta(t1, t2):
    fmt = "%a %d %b %Y %H:%M:%S %z"
    t1, t2 = [datetime.strptime(d, fmt) for d in [t1, t2]]
