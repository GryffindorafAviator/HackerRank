...
# It's composed of a username, 
# domain name, 
# and extension assembled in this format: 
...
# Hint: 
# Try using Email.utils() to complete this challenge. 
# For example, 
# this code:
# import email.utils
...
for _ in range(n):
    ne = email.utils.parseaddr(input())
    
    if re.match(pattern, ne[1]):
        print(f'{ne[0]} <{ne[1]}>')
