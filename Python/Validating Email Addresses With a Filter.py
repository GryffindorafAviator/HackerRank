...
# digits, 
# dashes and underscores [a - z],
# [A - Z],
# [0 - 9],
# [_-].
# The website name can only have letters and digits [a - z],
# [A - Z],
# [0 - 9].
# The extension can only contain letters [a - z],
# [A - Z].
...
# Now, 
# you only require those elements that are greater than 10 but less than 80.
...
# Returns
# boolean: 
# whether the string is a valid email or not

# Input Format
# The first line of input is the integer N, 
