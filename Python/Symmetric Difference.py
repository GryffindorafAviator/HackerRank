# Objective
# Today, 
# we're learning about a new data type: sets.
...
# To specify that comma is the delimiter, 
# use string.split(','). 
# For this challenge, 
# and in general on HackerRank, 
# space will be the delimiter.
