...
# Out of these 6 combinations, 
# 5 of them contain either index 1 or index 2 which are the indices that contain the letter 'a'.
...
for item in itertools.combinations(l, r):
    if 'a' in item:
        cnt += 1
