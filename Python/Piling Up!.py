...
# 7, 
# choose the leftmost element, 
# 1. 
# After than, 
# the choices are 2 and 8. 
...
# no order gives an appropriate arrangement of vertical cubes. 
...
for i in range(tests):
    n_blcks = int(input())
    blcks = list(map(int, input().split()))
