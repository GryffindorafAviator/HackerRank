...
# and you have to print the result of their addition, 
# subtraction, 
# multiplication, 
...
# For complex numbers where the real part is zero and the complex part (B) is non-zero, 
# the output should be:
# 0.00 + Bi
...
# Concept
# Python is a fully object-oriented language like C++, 
# Java, 
# etc. 

# Methods with a double underscore before and after their name are considered as built-in methods. 
# They are used by interpreters and are generally used in the implementation of overloaded operators or other built-in functionality.
...
class Complex(object):
    ...
    def mod(self):
        m = math.sqrt(pow(self.real, 2) + pow(self.imaginary, 2))
