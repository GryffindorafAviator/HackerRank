...
# The ordered list of scores is [20.0, 50.0], 
# so the second lowest score is 50.0. 
...
# The lowest grade of 37.21 belongs to Tina. 
...
if __name__ == '__main__':
    ...
    temp_list = list(set(grade for _, grade in grade_list))
    temp_list.sort()
    second_grade = temp_list[1]
    
    grade_list.sort()
  
    ans = '\n'.join([name for name, grade in grade_list if grade == second_grade])
    print(ans)
