...
# HTMLParser
# An HTMLParser instance is fed HTML data and calls handler methods when start tags, 
# end tags, 
# text, 
# comments, 
...
# Your task is to print start tags, 
# end tags and empty tags separately.
...
# attribute or attribute value inside the HTML comment tags (<!-- Comments -->).Comments can be multiline as well.
...
# Output Format
# Print the HTML tags, 
# attributes and attribute values in order of their occurrence from top to bottom in the given snippet.
