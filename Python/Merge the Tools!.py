...
# A string, 
# s, 
# of length n where s = c0c1...cn-1.
# An integer, 
# k, 
# where k is a factor of n.
# We can split s into n/k substrings where each subtring, 
# ti, 
...
# Given s and k, 
# print n/k lines where each line i denotes string ui.
...
# 'AAA', 'BCA' and 'DDE'. 
# The first substring is all 'A' characters, 
# so u1 = "A". 
