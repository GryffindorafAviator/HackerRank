...
// To get you started, 
// a portion of the solution is provided for you in the editor; 
...
// and each integer will be in the inclusive range from 0 to 199.

// Output Format

// In each line of output there should be two columns:
// The first column contains the String and is left justified using exactly 15 characters.
// The second column contains the integer, 
